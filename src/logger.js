 ...
 * 
 * Note:
 *  coreLogger also does it best to manage the console output, according to the verbosity level set at initialization time.
 *  Though this is not the case for log level, the verbosity level may be pushed in a LIFO stack, to make use of a temporary
 *  new level....
 * 
 * Rationales:
...
export class coreLogger {
     ...
     *   Kernel constant    Pino method                                             coreLogger  console           msg
     *   ---------------    -----------                                             ----------  -------           --------
     *                                                                                            0 fully quiet
