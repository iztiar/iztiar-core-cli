...
export class coreResult extends Error {
    ...
    static e = {
        COMMAND_UNSET: 'command expected, found undefined, null or empty',
        COMMAND_UNKNOWN: 'unknwon command',
        COMMAND_UNDEFINED: 'undefined command',
