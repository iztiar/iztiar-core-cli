...
import { Iztiar, coreLogger, corePackage, coreForkable, coreController, utils } from './imports.js';
...
export class coreBroker extends coreForkable {
    ...
    _tryToTerminate(){
        ...
        if( this._count >= 2 ){
            let code = 0;
            utils.jsonRemoveKeySync( coreController.getJsonPath( this.getConfig().controller.name ), Iztiar.c.forkable.BROKER );
