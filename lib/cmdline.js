...
let _command = null;
let _options = null;                   // options read in command-line
...
export class coreCmdline {
    ...
    static copyright(){
        ...
        text += '\nCopyright (@) 2020,2021,2022 TheDreamTeam&Consorts (and may the force be with you;))';
        return text;
    }
    ...
    static parse(){
        ...
        Iztiar.storageDir( _options.storage );
        ...
        if( _subCount !== 1 ){
            throw new coreResult(  _subCount ? err.ACTION_TOO_MANY : err.ACTION_NOT_FOUND );
        }
    }
