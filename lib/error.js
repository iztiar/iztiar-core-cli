...
export class coreError extends Error {
    ...
    static e = {
        ...
        CONTROLLER_BADPROCESS: 'trying to fork a coreBroker but I\'m not in a coreController process',
        CONTROLLER_BROKERDISABLED: 'trying to fork a coreBroker while the coreController configuration disable it',
        FORKABLE_APPCONFUNSET: 'service name expected, found undefined, null or empty',
        ...
        FORKABLE_CONTCONFUNSET: 'runtime configuration expected, found undefined, null or empty',
        FORKABLE_NAMEUNSET: 'service name expected, found undefined, null or empty',
