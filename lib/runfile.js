...
export class coreRunfile {
    ...
    */
     ...
     * @returns {JSON|null} the value of the key for the forkable in the JSON runfile of the named controller service
     * @throws coreResult (but not ENOENT, this being already handled)
     * 
     ...
     */
    remove(){
        return jsonRemoveKeySync( this._runfname, this._forkable );
    }
